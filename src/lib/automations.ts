...
export const AUTOMATIONS: Automation[] = [
  ...
  {
    id: "auto-approve",
    name: "Guide auto-approval",
    status: "live",
    what: "Approves the research run's guide ideas the moment they land, so builds start without you. Off means every researched guide idea waits as pending for your call on Home. Trend-radar takes always wait for you either way.",
    schedule: "With every research run",
    flow: ["Guide idea queued", "Auto-approved", "Ready to build"],
    staticEvidence: "Off = the human gate on WHAT gets written. On = the queue feeds itself.",
    control: { flag: "auto_approve" },
  },
  {
    id: "tool-approve",
    name: "Tool auto-approval",
    status: "live",
    what: "Approves the research run's tool ideas on their own. Auto-approved tools don't build instantly - they queue for the weekly tool build, one a week. Off means every tool concept waits as pending for your greenlight on Home; your own approvals always build immediately.",
    schedule: "With every research run",
    flow: ["Tool idea queued", "Auto-approved", "Weekly build slot"],
    staticEvidence: "Off = you greenlight every tool concept. On = one new tool ships itself each week.",
    control: { flag: "auto_approve_tools" },
  },
  {
    id: "guide-builder",
  ...
  },
  {
    ...
    name: "Tool builder",
    status: "live",
    what: "Builds an approved tool idea into a working page through the tool pipeline. Your own approvals fire it instantly; auto-approved ideas wait for the weekly sweep, so at most one tool ships per week on its own.",
    schedule: "Instantly on your approvals - weekly sweep Wednesdays 05:30 UTC",
    flow: ["Tool idea approved", "Build trigger", "Build per template", "PR + live validation", "Auto-merge on pass"],
