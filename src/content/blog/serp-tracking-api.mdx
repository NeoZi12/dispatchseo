...
No. The API is one stateless call - a snapshot for one keyword at one moment. A rank tracker is that call wired into storage, a schedule, and history; nothing about the API itself remembers what it returned yesterday.
