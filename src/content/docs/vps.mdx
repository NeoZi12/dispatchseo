...
Do this after finishing the setup wizard in your browser - the wizard's
One-tap merge step creates the GitHub access the builder reuses. (Doing
it earlier breaks nothing: the builder just idles and says what it's
waiting for.)
